    ...
    <div class="container">
        <form action="censura.php" method="get">
            <div class="mb-3">
                ...
                <input type="text" name="paragraph" id="paragraph" class="form-control" placeholder="paragrafo"
            ...
            <div class="mb-3">
                ...
                <input type="text" name="censura" id="censura" class="form-control" placeholder="censura"
